...
const Sidebar = () => {
  ...
  return (
    <div className="flex-[3] border border-gray-200">
      ...
      <div className="flex items-center gap-2 text-md font-medium text-gray-700 hover:bg-pink-700 hover:text-white py-2 px-4 uppercase border-b last:border-b-transparent cursor-pointer">
        <RiLogoutBoxFill />
        Logout
      </div>
    </div>
